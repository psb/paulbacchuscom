...
import noTime from "../assets/images/2023-10-09/no-time.png";
...
<Image src={noTime} alt="" layout="constrained" width={500}/>
</div>
...
```
├── README.md
// [!code word:reason_app/:1]
├── reason_app/
│   ├── api/
│   │   └── joke/
// [!code word:dune:1]
│   │       ├── dune
// [!code word:route.re:1]
│   │       └── route.re
│   ├── jokes/
// [!code word:dune:1]
│   │   ├── dune
...
Thank you to [Javier Chávarri](https://x.com/javierwchavarri) for the help with Dune.
