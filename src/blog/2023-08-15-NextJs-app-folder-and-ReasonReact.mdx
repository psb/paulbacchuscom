...
import buildOutput from "../assets/images/2023-08-15/reason-files-to-js-files.png";
import dune from "../assets/images/2023-08-15/dune-files-everywhere.webp";
import gopher from "../assets/images/2023-08-15/gopher.png";
import outputInSrc from "../assets/images/2023-08-15/output-in-src.webp";
...
<figure>
<Image src={buildOutput} alt="build folder structure" layout="constrained" width={750}/>
<figcaption>Left: Reason folder structure. Right: JS output folder structure in the `_build` directory.</figcaption>
</figure>
...
<Image src={dune} alt="dune files everywhere" layout="constrained" width={600}/>
</div>
...
<div class="markdown-image">
<Image src={gopher} alt="" layout="constrained" width={400}/>
</div>
...
<figure>
<Image src={outputInSrc} alt="JS output code is promoted back into the src folder" layout="constrained" width={500}/>
<figcaption>Transpiled JS output code is promoted back into the `src` folder.</figcaption>
</figure>
